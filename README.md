...
## Instructions
To install and use functionalities, pull the repository and call `pip install -e .` or `pip install -e ".[hvd]"` for `horovod` support.

`run.py` script sets up and runs the training.
```
$ python run.py -h
